...
<div class="box" id="login">
    <div style="margin-bottom: 30px">
        <spring:message code="screen.welcome.message"/>
    </div>
    <div id="applicationTypeButtonsHolder">
        <button value="Login via Chorus" id="loginViaChorus">Login via Chorus</button>
        <button value="Login via Panorama" id="loginViaPanorama">Login via Panorama</button>
    </div>
