...
Func _SetAddress($windowTitle, $folderPath)
   Sleep(500)
   ;click on the address bar on Win 2008 R2 Server
   If $OS = "WIN_2008R2" Then
	  ControlClick($windowTitle, "", "ToolbarWindow322", "left", 1, 260, 10)
   ;click on the address bar on Win 2008 Server and Windows 8.1
	  ElseIf $OS = "WIN_2008" Or $OS = "Win_81" Then
		 ControlClick($windowTitle, "", "ToolbarWindow323", "left", 1, 260, 10)
   ;click on the address bar on Win 7
      ElseIf $OS = "WIN_7" Then
		 ControlClick($windowTitle, "", "ToolbarWindow322", "left", 1, 600,10)
   EndIf
   Sleep(500)
   ...
   Sleep(200)
   ;press "Go to" button on Win 2008 R2 Server
   If $OS = "WIN_2008R2" Then
	  ControlClick($windowTitle, "", "ToolbarWindow323")
   ;press "Go to" button on Win 2008 Server and Windows 8.1
	  ElseIf $OS = "WIN_2008" Or $OS = "Win_81" Then
		 ControlClick($windowTitle, "", "ToolbarWindow324")
   ;press "Go to" button on Win 7
	  ElseIf $OS = "WIN_7" Then
		 ControlClick($windowTitle, "", "ToolbarWindow323")
   EndIf
   Sleep(500)
