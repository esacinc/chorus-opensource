...
Func _SetAddress($windowTitle, $folderPath)
   Sleep(500)
   If $OS = "WIN_2008" Then
	  ControlClick($windowTitle, "", "ToolbarWindow323", "left", 1, 260, 10) ;click on the address bar on Win 2008 Server
   ...
   Sleep(200)
   If $OS = "WIN_2008" Then
	  ControlClick($windowTitle, "", "ToolbarWindow324") ;press "Go to" button on Win 2008 Server
	  ElseIf $OS = "WIN_7" Then
