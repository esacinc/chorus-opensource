 ...
 */
public class DMSSearchDataProvider {
    ...
    public static Object[][] openSearchAndVerifyNumberOfFiles() {
        ShotGunSearchData shotGunSearchData = new ShotGunSearchData.Builder()
                .annotationItemsFromCsvFile(CSVFileReader.getDataFromCsvFile("/data/proteinidsearchdata/dms/raw/protein/raw_protein_annotation_table.csv"))
                .dataItemsFromCsvFile(CSVFileReader.getDataFromCsvFile("/data/proteinidsearchdata/dms/raw/protein/raw_protein_data_table.csv"))
                .build();
    ...
    public static Object[][] selectNormalizedPeptide() {
        ShotGunSearchData shotGunSearchData = new ShotGunSearchData.Builder()
                .annotationItemsFromCsvFile(CSVFileReader.getDataFromCsvFile("/data/proteinidsearchdata/dms/normalized/peptide/normalized_peptide_annotation_table.csv"))
                .dataItemsFromCsvFile(CSVFileReader.getDataFromCsvFile("/data/proteinidsearchdata/dms/normalized/peptide/normalized_peptide_data_table.csv"))
    ...
    public static Object[][] selectConditionIsotopeGroup() {
        ShotGunSearchData shotGunSearchData = new ShotGunSearchData.Builder()
                .annotationItemsFromCsvFile(CSVFileReader.getDataFromCsvFile("/data/proteinidsearchdata/dms/condition/isotopegroup/condition_isotopegroup_annotation_table.csv"))
                .composeBy("Condition")
    ...
    public static Object[][] selectRatioFeature() {
        ShotGunSearchData shotGunSearchData = new ShotGunSearchData.Builder()
                .annotationItemsFromCsvFile(CSVFileReader.getDataFromCsvFile("/data/proteinidsearchdata/dms/ratio/feature/ratio_feature_annotation_table.csv"))
                .composeBy("Ratio")
                .viewLevel("Feature")
                .build();
        return new Object[][]{{shotGunSearchData}};
    ...
    public static Object[][] normalizeIntensitiesSheetAndZScoreAndANOVA() {
        ...
        ShotGunSearchData shotGunSearchData = new ShotGunSearchData.Builder()
                .annotationItemsFromCsvFile(CSVFileReader.getDataFromCsvFile("/data/proteinidsearchdata/dms/complexalgorithms/normalized_zscore_anova_annotation_table.csv"))
                .dataItemsFromCsvFile(CSVFileReader.getDataFromCsvFile("/data/proteinidsearchdata/dms/complexalgorithms/normalized_zscore_anova_data_table.csv"))
    ...
    public static Object[][] filteringAndNormalizationAndLog2AndRatio() {
        ...
        ShotGunSearchData shotGunSearchData = new ShotGunSearchData.Builder()
                .annotationItemsFromCsvFile(CSVFileReader.getDataFromCsvFile("/data/proteinidsearchdata/dms/complexalgorithms/filtering_normalization_log2_ratio_annotation_table.csv"))
                .dataItemsFromCsvFile(CSVFileReader.getDataFromCsvFile("/data/proteinidsearchdata/dms/complexalgorithms/filtering_normalization_log2_ratio_data_table.csv"))
                .algorithmData(algorithmDataList)
                .build();
        return new Object[][]{{shotGunSearchData}};
    }
    ...
    public static Object[][] saveAnalysisAndThenLoad() {
        ...
        algorithmDataList.add(aNovaAlgorithm);
        ShotGunSearchData shotGunSearchData = new ShotGunSearchData.Builder()
                .annotationItemsFromCsvFile(CSVFileReader.getDataFromCsvFile("/data/proteinidsearchdata/dms/complexalgorithms/sorting_logn_anova_annotation_table.csv"))
                .dataItemsFromCsvFile(CSVFileReader.getDataFromCsvFile("/data/proteinidsearchdata/dms/complexalgorithms/sorting_logn_anova_data_table.csv"))
                .algorithmData(algorithmDataList)
                .build();
